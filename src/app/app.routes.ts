...
// if its https://demo-sandbox.verifik.co it should use sandboxProject
// if its production it should use verifikProject
// if its localhost it should use sandboxProject
const defaultPath =
    window.location.hostname.includes('localhost') ||
    window.location.hostname.includes('demo-sandbox.verifik.co')
    ...
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'demo' },
    {
        ...
        children: [
            ...
            },
            {
                path: 'kyc',
                loadChildren: () =>
                    import('app/modules/auth/kyc-steps/kyc-steps.routes'),
            },
            {
                path: 'reset-password',
                loadChildren: () =>
